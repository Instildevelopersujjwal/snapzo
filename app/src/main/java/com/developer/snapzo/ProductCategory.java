...
public class ProductCategory extends ActionBarActivity {
    ...
    TextView txtcount;
int finalproduct,categoryintent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            finalproduct = Integer.parseInt(getIntent().getExtras().getString("position2"));
          categoryintent = getIntent().getExtras().getInt("categoryvalue");
           // Toast.makeText(ProductCategory.this,"pc_final:"+finalproduct,Toast.LENGTH_SHORT).show();

        catMap = new HashMap<String, String>();
        catMap = categoryArray.get(categoryintent);
        ...
        products_listview.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                Intent intent = new Intent(ProductCategory.this, ProductdetailActivity.class);
        ...
        new ProductCategory.loadProductsTask().execute(true);
...
/*
        ...
        {
           // Toast.makeText(ProductCategory.this,"Error:"+e.getMessage(),Toast.LENGTH_LONG).show();
        }
*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.action_viewcart){
            Intent intent = new Intent(ProductCategory.this,ViewcartActivity.class);
            startActivity(intent);
 ...
 //   }
    ...
    public class loadProductsTask extends AsyncTask<Boolean, Void, ArrayList<HashMap<String, String>>> {
        ...
        protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
            ...
            try {
                settings.edit().putString("products",ObjectSerializer.serialize(products_array)).commit();
            } catch (IOException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
           ...
           // adapter = new ProductsAdapter(getApplicationContext(), products_array);
          //  products_listview.setAdapter(adapter);
           // Toast.makeText(ProductCategory.this,"done",Toast.LENGTH_SHORT).show();
            adapter.notifyDataSetChanged();
            ...
            try {
                ...
                if(cd.isConnectingToInternet())
                {
                   // String urlstring = ConstValue.JSON_PRODUCTS+"&id="+catMap.get("id");
                    String urlstring = ConstValue.JSON_PRODUCTS+"&id="+finalproduct;
                    ...
                    if (json.has("data")) {
                        if(json.get("data") instanceof JSONArray){
                          ...
                          //  Toast.makeText(ProductCategory.this,"length:"+jsonDrList.length(),Toast.LENGTH_SHORT).show();
                ...
                {
                    Toast.makeText(ProductCategory.this,getString(R.string.internetconnection), Toast.LENGTH_LONG).show();
                }
