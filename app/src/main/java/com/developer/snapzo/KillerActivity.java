...
public class KillerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // int a = Integer.parseInt(getIntent().getExtras().getString("address"));
...
//    View v = inflator.inflate(R.menu.main, null);
       ...
       //             .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        {
            Toast.makeText(KillerActivity.this,"Error:"+e.getMessage(),Toast.LENGTH_LONG).show();
        }
        set_fragment_page(0);
    }
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.action_viewcart){
            ...
            Intent intent = new Intent(KillerActivity.this,ViewcartActivity.class);
            startActivity(intent);

        }

        else if(id == android.R.id.home){
            Intent intent = new Intent(KillerActivity.this,MainActivity.class);
            startActivity(intent);
            finish();
        }
...
if(position==0){
        HomeFragment2 newFragment = new HomeFragment2();
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        ft.replace(R.id.sample_content_fragment2, newFragment).commit();}
        ...
        if (fragment!=null) {
            ...
            if (position==0) {
                fragmentManager.beginTransaction()
                        .replace(R.id.sample_content_fragment2, fragment)
                        .commit();
            }else{
                fragmentManager.beginTransaction()
                        .replace(R.id.sample_content_fragment2, fragment)
