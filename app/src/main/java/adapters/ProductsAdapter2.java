...
public class ProductsAdapter2 extends BaseAdapter {
	...
	public ProductsAdapter2(Context context, ArrayList<HashMap<String, String>> arraylist){
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
	            ...
	            convertView = mInflater.inflate(R.layout.row_products2, null);
	        }
		...
		/*	TextView txtDiscountFlag = (TextView)convertView.findViewById(R.id.textDiscountFlag);
			...
			int a = Integer.parseInt(map.get("total_qty_stock"));
			int b = Integer.parseInt(map.get("consume_qty_stock"));
		  //  int a = 5;
		  //  int b = 5 ;
			int result = a - b;
